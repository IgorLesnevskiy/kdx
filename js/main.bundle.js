	...
	_createClass(CCarambaController, [{
		...
		value: function loadData() {
			...
			return new Promise(function (resolve, reject) {
				...
				var localData = _this3.getAllRowsFromLocalStorage();
				var mergedData = {};
   ...
   */
		...
		value: function getTextByLocale() {
			...
			return function (text) {
				return _this4.text && _this4.text[locale] && _this4.text[locale][text] ? _this4.text[locale][text] : false;
			};
		}
	}, {
		key: 'lockTable',
		...
		value: function initDeleteTrigger() {
			...
			this.$tableWrapper.on('click', '.js-delete-trigger', function (e) {
				...
				if ($row.length) {
					...
					.then(function () {
						$row.remove();
						_this5.deleteRowFromLocalStorage(rowID);

						if (_this5.isNoRows()) {
							_this5.showTableNotification(_this5.getText('error--empty_data'));
						}

						_this5.updateSummaryPrice();
						_this5.unlockTable();
					});
				}
			});
